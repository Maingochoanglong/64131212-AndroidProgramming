package ntu.maingochoanglong.ex5_addsubmuldiv_var;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TimDieuKhien();
        button_Cong.setOnClickListener(boLangNghe_XuLyCong);
        button_Tru.setOnClickListener(boLangNghe_XuLyTru);
        button_Nhan.setOnClickListener(boLangNghe_XuLyNhan);
        button_Chia.setOnClickListener(boLangNghe_XuLyChia);
    }
